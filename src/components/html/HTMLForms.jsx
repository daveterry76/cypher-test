  ...
  return (
    <div>
      ...
      <h3 className="text-lg italic opacity-70">
        Summary: Forms are crucial for user interaction on the web. Learn how to create HTML forms to collect user input, validate data, and submit it
        to a server. This sub-section covers form elements, input types, and form validation techniques.
      </h3>
      ...
      <div className="flex flex-col bg-green-200 rounded-md px-5 py-2">
        ...
        <p className="text-green-500">
          Elevate user interaction with HTML Forms – the gateway to collecting and validating user input. Delve into the intricacies of form
          structure, common input types, and techniques for seamless form validation. Unlock the power to create engaging and user-friendly web
          experiences.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-12 my-12">
        <div id="1">
          ...
          <p className="leading-loose text-lg">
            Explore the anatomy of HTML forms, understanding the essential elements like `form`, `input`, and `button`. Learn how these tags work
            together to create a seamless user input experience on your web pages.
          </p>
        </div>
        ...
        <div id="2">
          ...
          <p className="leading-loose text-lg">
            Dive into the variety of input types available in HTML forms. From text fields (`input type="text"`) to checkboxes (`input
            type="checkbox"`) and radio buttons (`input type="radio"`), uncover the versatility of input elements for different user interactions.
          </p>
        </div>
